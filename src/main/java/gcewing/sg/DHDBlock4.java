...
public class DHDBlock4 extends DHDBlock0 {
   protected static String[] textures = new String[]{"dhd_top4", "dhd_side4", "stargateBlock4", "dhd_button_dim4"};
   ...
   public void breakBlock(World world, BlockPos pos, IBlockState state) {
      ...
      if (cte != null && cte.isLinkedToStargate) {
         SGBaseTE gte = cte.getLinkedStargateTE((byte)4);
         if (gte != null) {
